...
<template>
  <div class="product-card">
    ...
    <!-- Image -->
    <div class="image-box">
      <img :src="`http://localhost:3000/`" class="product-img" />
    </div>
    ...
    <!-- Short description -->
    <p v-if="description" class="product-desc">
      {{ description }}
    </p>
    ...
    <div class="rating">
      <span 
        ...
        :key="i"
        class="star"
        :class="{ filled: i <= safeRating }"
      >★</span>
      <span class="rate-number">({{ safeRating }})</span>
    </div>
    ...
    <div class="bottom-row">
      ...
      <button 
        class="add-btn"
        @click="$emit('add-to-cart', { title, price })"
      >
        <span>Add</span>
